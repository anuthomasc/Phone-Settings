    ...
    return (
      <ScrollView style={styles.container}>
        ...
        <StatusView
          ...
          switchFunc={(value) => this._airplaneSwitch()} />
        <StatusView
          title='Location'
          value={locationEnable}
          loading={locationStateLoading}
          switchFunc={(value) => this._locationSwitch()} />
        <StatusView
          title='Bluetooth'
          value={bluetoothEnable}
          loading={bluetoothStateLoading}
          switchFunc={(value) => this._bluetoothSwitch()} />
        <StatusView
          title='Wifi'
          value={wifiEnable}
          loading={wifiStateLoading}
          switchFunc={(value) => this._wifiSwitch()} />
        <ValueView
          title='Volume'
          btn={this.isAndroid && {
          ...
          value={volume}
          changeVal={(val) => this._changeVolume(val)}
